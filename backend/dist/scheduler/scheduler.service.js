...
let SchedulerService = SchedulerService_1 = class SchedulerService {
    constructor(fileRecordRepo, settingRepo, readingRepo) {
    ...
    async processDataFiles() {
        try {
            ...
            for (const file of files) {
                ...
                const parsedReadings = (0, parse_log_file_1.parseLogFile)(fileContent, dateFromFile);
...
SchedulerService = SchedulerService_1 = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(file_record_entity_1.FileRecord)),
